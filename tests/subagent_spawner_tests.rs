...
async fn test_subagent_spawner_spawn_with_empty_prompt() -> Result<()> {
    ...
    let result = spawner.spawn_agent("cursor-agent", &temp_path, "", &options).await;
...
async fn test_cursor_cli_agent_name_consistency() -> Result<()> {
    ...
    assert_eq!(agent1.name(), "cursor-agent", "Agent name should be 'cursor-agent'");
...
async fn test_agent_options_edge_cases() -> Result<()> {
    ...
    assert_eq!(options_large.new_window, false, "Should handle new_window setting");
...
async fn test_agent_info_creation_edge_cases() -> Result<()> {
    ...
    assert_eq!(info_empty.available, false, "Should handle unavailable agent");
    assert_eq!(info_empty.version, "", "Should handle empty version");
    assert_eq!(info_empty.description, "", "Should handle empty description");
    ...
    assert_eq!(info_long.description.len(), 1000, "Should handle long description");
